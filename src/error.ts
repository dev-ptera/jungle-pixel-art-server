...
export const PAYMENT_SETS_FULL =
    'The payments sets are full.  Unable to handle incoming purchase, please try again later.';
export const PAYMENT_TIMEOUT = 'The payment request has timed out.  Please close this window and try again.';
export const CONFLICTING_PIXEL_BOARD =
    'Someone overwrote your pixels.  The affected pixels have been overwritten.  Please close this window.';
